...
HOME_TEXT = "👋🏻 **Hi [{}](tg://user?id={})**,\n\nI'm **Radio Player V3.0** \nI Can Play Radio / Music / YouTube Live In Channel & Group 24x7 Nonstop. Made with ❤️ By<b> нαяѕнυ_х∂ </b>😉!"
HELP_TEXT = """
💡 --**Setting Up**--:
    ...
    if query.data.lower() == "replay":
        ...
        buttons = [
            ...
            [
                ...
                InlineKeyboardButton("Managed By", url="https://t.me/Harshu_xD"),
            ],
            [
                InlineKeyboardButton("ADD ME", url="https://t.me/StarterMusicBot?startgroup=true"),
                InlineKeyboardButton("SOURCE CODE", url="https://t.me/Harshu_xD"),
            ],
            [
